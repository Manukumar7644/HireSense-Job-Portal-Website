        ...
        try {
            ...
            if (logs != null && !logs.isEmpty()) {
                ...
                org.json.JSONObject obj =
                        new org.json.JSONObject(resultJson);

                org.json.JSONObject data =
                        obj.getJSONObject("data");

                resumePath = data.optString("resumePath", null);
            }

            // ❌ If resume not found → stop
            if (resumePath == null || resumePath.isEmpty()) {
                res.sendRedirect("userDashboard?error=no_resume");
                return;
            }

            // ================= SAVE APPLICATION =================
            ApplicationPojo app = new ApplicationPojo(
                    0, userId, jobId, resumePath,
                    score, "applied", null
            );
            ...
            UserPojo employer =
                    UserDAO.getUserById(job.getEmployerId());
